...
/*
 * To set pin INITIAL_VALUE
 *          floating if input    |   low if output     : 0
 *          pulled-up if input   |   high if output   : 1
                                    */

/*PORTA Pins INITIAL_VALUE*/
